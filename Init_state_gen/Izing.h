...
namespace Izing
{
	...
	extern int OP_min_default[2];
	extern int OP_max_default[2];
	extern int OP_peak_default[2];
...
py::tuple run_bruteforce(int L, double Temp, double h, int Nt_max,
						 std::optional<int> OP_to_save_min, std::optional<int> OP_to_save_max,
						 std::optional<int> interface_mode, std::optional<int> _verbose);
