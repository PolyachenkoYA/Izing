...
def main():
	...
	# python slurm_test.py --mode launch_run --MC_mode long_swap --OP_set_name nvtBig --seed_s -1 1000 1010 --n_s 30 --L_s 320 --phi1_s 0.015 --Temp_s 1.0 --slurm_time 144:00:00 --to_run 0
	
	parser = argparse.ArgumentParser()
	
	parser.add_argument('--mode', help='what to do', choices=['launch_run_FFS', 'launch_run_Dtop', 'search_logs', 'search_npzs'], required=True)
