	...
	if(Dtop_Nruns > 0):
		...
		if(Dtop_Nruns > Dtop_Nruns_perState_min * len(parent_state_source_IDs)):
			...
			if(Dtop_NparentStates_to_use > 0):
				parent_state_IDs = np.append(np.tile(parent_state_source_IDs[:Dtop_NparentStates_to_use]), Dtop_Nruns_perState_min), \
							parent_state_source_IDs[:Dtop_NparentStates_to_use][:(Dtop_Nruns - Dtop_NparentStates_to_use * Dtop_Nruns_perState_min)])
